...
public class NombreUsuarioExistente extends JDialog {
	...
	public static void main(String[] args) {
		try {
			NombreUsuarioExistente dialog = new NombreUsuarioExistente();
	...
	public NombreUsuarioExistente() {
		...
		{
			JLabel lblmensaje = new JLabel("Nombre de usuario ya existe");
